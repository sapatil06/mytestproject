...
public void navigateToWebTablePage()
{
	...
	jsh.scrollIntoViewAndClick(driver.findElement(webTablesPage));
...
public void addNewUserOnWebTablePage(WebTableObjectClass newUserData)
{
	...
	wt.until(ExpectedConditions.visibilityOf(driver.findElement(addButtonOnwebTablesPage)));
